...
- [ ] 3.1 Test eyecite candidate extraction and antecedent resolution without
      treating extraction as verification.
- [ ] 3.2 Test and implement persistent identity, missing-authority, status,
      quotation, pinpoint, and unusable-text-layer findings.

## 4. Output boundary

- [ ] 4.1 Test deterministic JSON, Markdown, YAML receipts, input preservation,
