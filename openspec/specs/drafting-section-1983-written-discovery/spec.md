# drafting-section-1983-written-discovery Specification

## Purpose

Define traceable, bounded Section 1983 requests for production, interrogatories,
and requests for admission that distinguish expected sources from established
content and reserve discovery strategy for the plaintiff.
