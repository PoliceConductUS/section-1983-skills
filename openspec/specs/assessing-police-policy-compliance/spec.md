...
Define an offline folder-native skill that assesses validated police-policy
requirements against source-documented actor, event, phase, and case-record
files without deciding legal liability.
