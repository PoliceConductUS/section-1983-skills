...
| `building-judicial-reasoning-profiles`            | Generic builder for evidence-bounded, immutable Judicial Reasoning Profile packages from approved public sources.                                                          |
...
6. Use `building-judicial-reasoning-profiles` to acquire approved public sources
   or compile a validated profile package for the assigned judge. A later shared
   launcher owns profile-backed judicial review.
