...
1. Search Top 50 terms.
2. Delete intensifiers that add only volume.
3. Replace accusation labels with the actual legal or factual defect.
4. Convert legalese to plain English unless a legal standard requires the term.
5. Quantify vague degree words when the point depends on degree.
6. Remove sentence adverbs and throat-clearers.
7. Remove sarcasm, mind-reading, and court-directed emotion.
8. Keep terms of art, but simplify surrounding prose.
...
| Instead of                    | Usually try                |
| ----------------------------- | -------------------------- |
| pursuant to                   | under                      |
| prior to                      | before                     |
| subsequent to                 | after / later              |
| utilize                       | use                        |
| aforementioned                | above / described above    |
| upon                          | on                         |
| instant case                  | this case                  |
| arguendo                      | assuming                   |
| in all honesty / the truth is | delete                     |
| it is important to note       | delete                     |
| most likely because           | state the evidence or omit |
...
- "This is obviously meritless" -> "The argument fails because..."
- "Pursuant to Rule 56" -> "Under Rule 56"
- "The opponent deliberately ignored" -> "The opponent did not address..."
- "It is important to note that the record contains" -> "The record contains"
