...
needed to establish Section 1983 and police or law-enforcement involvement.
The guide MUST require sanitized query provenance and an inspectable disposition
for each reviewed candidate, MUST explain that search metadata and search-result
...
access authorization separate from fee approval and MUST require an explicit
gap instead of implying that unavailable or unapproved official material was
checked.
