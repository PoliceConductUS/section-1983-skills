# building-defense-counsel-overlays Specification

## Purpose

Define an immutable, source-bounded method for evidence-coded professional
defense-attorney identity, time-bounded counsel-team behavior, separately
attributed court treatment, and calibrated next-move forecasts while preserving
public-source missingness, blind-review isolation, and non-personal boundaries.
