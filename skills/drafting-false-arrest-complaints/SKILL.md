...
5. **Draft each count through the required contract.** Use Element → Facts → Inference → Result. For every individual-capacity claim, establish the right at the required factual specificity and explain how verified, binding, pre-event authority gave that defendant fair warning. Use only relevant incorporated paragraphs.
