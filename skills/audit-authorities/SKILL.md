...
Before auditing, obtain the best available source copy for every cited
authority:
...
5. Do not mark an authority verified merely because a PDF was downloaded.
   ...
   check.
6. If a load-bearing or filing-near authority cannot be verified, mark a
...
- **Defendants' authorities cited only to distinguish**: Stages 2 (identity), 5
  ...
  pinpoint/context/quote verification since we're not relying on them for
  propositions
...
2. Confirm you're using the correct version/source (official reporter vs slip
