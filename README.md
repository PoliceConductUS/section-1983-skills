...
6. For a Rule 12 response plan, use `rrd-rule12` and then the officers or city
   ...
   complaint skills.
7. For discovery, use `drafting-section-1983-written-discovery`,
...
8. Before treating legal work as filing-ready, run `audit-authorities`, followed
...
9. Run `adversarial-filing-review` in a fresh clean-room context after
...
10. Run `filing-ci` after the applicable prose and authority audits, after each
